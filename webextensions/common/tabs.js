...
export function getMaxTreeLevel(hint, options = {}) {
  var tabs = options.onlyVisible ? getVisibleTabs(hint) : getTabs(hint) ;
  var maxLevel = Math.max(...tabs.map(tab => parseInt(tab.getAttribute(Constants.kLEVEL) || 0)));
